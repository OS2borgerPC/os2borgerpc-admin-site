...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "package",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, to="system.Package"
                    ),
                ),
            ],
        ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "file_value",
                    models.FileField(
                        blank=True, null=True, upload_to=system.models.upload_file_name
                    ),
                ),
                (
                    "batch",
                ...
                (
                    "input",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, to="system.Input"
                    ),
                ),
            ],
        ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "pc",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, to="system.PC"
                    ),
                ),
            ],
        ),
        ...
        migrations.AddField(
            ...
            name="problem",
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE, to="system.SecurityProblem"
            ),
        ),
        migrations.AddField(
            model_name="script",
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(
                blank=True, related_name="pcs", to="system.PCGroup"
            ),
        ),
        migrations.AddField(
            model_name="pc",
        ...
        migrations.AddField(
            ...
            name="packages",
            field=models.ManyToManyField(
                blank=True, through="system.PackageStatus", to="system.Package"
            ),
        ),
        ...
        migrations.AddField(
            ...
            name="package_list",
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE, to="system.PackageList"
            ),
        ),
        migrations.AddField(
            ...
            name="packages",
            field=models.ManyToManyField(
                blank=True, through="system.PackageInstallInfo", to="system.Package"
            ),
        ),
        migrations.AddField(
            model_name="batch",
