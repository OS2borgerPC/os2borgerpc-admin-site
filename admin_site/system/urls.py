...
urlpatterns = [
    ...
    url(r"^site/(?P<slug>[^/]+)/scripts/", ScriptList.as_view(), name="scripts"),
    # Users
    ...
    # Changelog
    url(r"^site/(?P<slug>[^/]+)/changes/$", ChangelogView.as_view(), name="changelog"),
    url(
        r"^site/(?P<site_uid>[^/]+)/changes/search/",
        ChangelogSearch.as_view(),
